...
- **[pandas_exercises](https://github.com/guipsamora/pandas_exercises)** — Colección práctica de ejercicios para dominar Pandas en Python. Ideal para fortalecer tus habilidades de manipulación y transformación de datos antes de aplicarlos a datasets metalúrgicos.

¿Tienes otro repositorio que complementaría bien con Metalúrgica Data? ¡[Abre un issue](https://github.com/elqvixote/metalurgica-data/issues) para recomendarlo!
---
## 🧾 Licencia
